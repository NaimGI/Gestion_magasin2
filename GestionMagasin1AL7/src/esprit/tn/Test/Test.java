...
public class Test {
    ...
    p4.afficher();
        ...
        Employee E1= new Vendeur(1,"Naim","Manzel temim",22,2.9);
        Employee E2= new Caissier(2,"Baha","Ma",0);
        Employee E3 = new Responsable(3,"mahdi","Tunisie",22,0.0);
        E1.toString();
